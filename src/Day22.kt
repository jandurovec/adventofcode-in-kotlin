...
fun main() {
    ...
    check(part1(parseInput("Day22_test1")) == 39L)
    check(part1(parseInput("Day22_test2")) == 590_784L)
    check(part2(parseInput("Day22_test3")) == 2_758_514_936_282_235)

    val input = parseInput("Day22")
    println(part1(input))
    println(part2(input))
}
